...
3) You may need to configure some parameters at the beginning of the file "StudentCombinator.py" 

4) Launch the program with the command "python3 StudentCombinator.py" or opening Python editor and pressing F5.

5) See results in ASSIGNMENTS.csv
